...
const honoredGuests = guests.slice(0, 1); // ["BRUTUS"]
const otherGuests = guests.slice(1); // The rest of the guests
otherGuests.sort(); // Sort the remaining guests alphabetically
const sortedGuests = honoredGuests.concat(otherGuests); // Merge them
